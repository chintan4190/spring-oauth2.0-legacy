package edu.learn.spring.oauth2.config;
...
public class JwkAuthorizationServerConfiguration {
    ...
    private static final String KEY_STORE_FILE = "my-jwt.jks";
    private static final String KEY_STORE_PASSWORD = "my-pass";
    private static final String KEY_ALIAS = "my-oauth-jwt";
    private static final String JWK_KID = "my-key-id";
